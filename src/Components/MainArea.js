   ...
   return (
      <>
         <div className="container">
            ...
            <button className="dark-mode" onClick={switchMode}>{btnState}</button>
            <textarea value={text} onChange={checkValue} className="user-input" style={mode} placeholder="ENTER YOUR TEXT HERE"></textarea>
            <br />
            ...
            <div className="text-summury">
               <h1>Text Summary</h1>
               <hr />
               <h3>Number of Character:{text.length}</h3>
               <h3>Number of Words:{noOfWords}</h3>
            </div>
